...
class ShopRepository:
    ...
    async def seed_default_shops_if_empty(self) -> List[Shop]:
        ...
        default_shops_data = [
            ...
            {
                "shop_name": "Sri Rama Agri Inputs & Fertilizers",
                "owner_name": "K. Rajeshwar Rao",
                "phone_number": "+91 9848123456",
                "email": "srirama.korutla@gmail.com",
                "address": "Main Road, Near Old Bus Stand, Korutla",
                "village": "Korutla",
                "mandal": "Korutla",
                "district": "Jagtial",
                "state": "Telangana",
                ...
                "inventory": [
                    ...
                    },
                    {
                        "product_name": "Fungicide Mancozeb 75% WP",
                        "category": "Fungicides",
                        "brand": "UPL Saaf / Dithane M-45",
                        "product_description": "Mancozeb 75% WP Contact Fungicide 500g",
                        "unit": "Packet",
                        "price": 310.0,
                        "quantity_in_stock": 35,
                        "minimum_stock_level": 5,
                    ...
                    {
                        "product_name": "19:19:19 WSF",
                        "category": "Fertilizers",
                        "brand": "Mahadhan",
                        "product_description": "100% Water Soluble NPK Fertilizer 1kg",
                        "unit": "Packet",
                        "price": 175.0,
                        "quantity_in_stock": 50,
                        "minimum_stock_level": 10,
