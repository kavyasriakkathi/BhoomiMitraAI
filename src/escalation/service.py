...
_LABELS_BY_LANG = {
    ...
    "en": _EN_LABELS,
    "hi": {
        "header":          "👨‍🌾 कृषि अधिकारी संपर्क टिकट: #{ticket_id}",
        "status":          "✅ स्थिति",
        "status_assigned": "जिला कृषि अधिकारी को सौंपा गया",
        "status_pending":  "अधिकारी आवंटन हेतु कतार में",
        "specialist":      "👤 विशेषज्ञ",
        "region":          "📍 क्षेत्र",
        "contact":         "📞 अधिकारी संपर्क",
        "callback":        "⏱️ अनुमानित कॉलबैक समय",
        ...
        "existing_ticket": "ℹ️ आपके पास पहले से एक सक्रिय टिकट (#{ticket_id}) है।",
        "no_local_expert": "ℹ️ वर्तमान में स्थानीय अधिकारी उपलब्ध नहीं हैं। आपका टिकट दर्ज कर लिया गया है।",
        "hazard_warning":  "⚠️ **सुरक्षा चेतावनी**: खतरनाक रसायनों के संपर्क से बचें और तुरंत कृषि व स्वास्थ्य अधिकारियों से संपर्क करें।",
        "inspection_note": "🌾 **खेत निरीक्षण अनुरोध दर्ज**: कृषि अधिकारी को सूचित कर दिया गया है।",
    },
    "ta": {
        "header":          "👨‍🌾 வேளாண் அலுவலர் உதவி டிக்கெட்: #{ticket_id}",
        "status":          "✅ நிலை",
        "status_assigned": "மாவட்ட வேளாண் அலுவலருக்கு ஒதுக்கப்பட்டது",
        "status_pending":  "அலுவலர் ஒதுக்கீட்டிற்காக காத்திருக்கிறது",
        "specialist":      "👤 நிபுணர்",
        "region":          "📍 பகுதி",
        "contact":         "📞 அலுவலர் தொடர்பு",
        "callback":        "⏱️ திரும்ப அழைக்கும் நேரம்",
        "callback_time":   "30–60 நிமிடங்களுக்குள்",
        "helpline_title":  "🚨 கிசான் கால் சென்டர் (இலவச எண்)",
        "helpline_number": "📞 1800-180-1551 (காலை 6:00 - இரவு 10:00)",
        "existing_ticket": "ℹ️ உங்களுக்கு ஏற்கனவே ஒரு டிக்கெட் (#{ticket_id}) உள்ளது.",
        "no_local_expert": "ℹ️ தற்போது உள்ளூர் அலுவலர் இல்லை. டிக்கெட் பதிவு செய்யப்பட்டுள்ளது.",
        "hazard_warning":  "⚠️ **பாதுகாப்பு எச்சரிக்கை**: உடனடியாக அதிகாரிகளை தொடர்பு கொள்ளவும்.",
        "inspection_note": "🌾 **கள ஆய்வு கோரிக்கை பதிவு செய்யப்பட்டது**.",
    },
    "kn": {
        "header":          "👨‍🌾 ಕೃಷಿ ಅಧಿಕಾರಿ ಸಂಪರ್ಕ ಟಿಕೆಟ್: #{ticket_id}",
        "status":          "✅ ಸ್ಥಿತಿ",
        "status_assigned": "ಜಿಲ್ಲಾ ಕೃಷಿ ಅಧಿಕಾರಿಗೆ ನಿಯೋಜಿಸಲಾಗಿದೆ",
        "status_pending":  "ಅಧಿಕಾರಿ ನಿಯೋಜನೆಗಾಗಿ ಕಾಯುತ್ತಿದೆ",
        "specialist":      "👤 ತಜ್ಞರು",
        "region":          "📍 ಪ್ರದೇಶ",
        "contact":         "📞 ಅಧಿಕಾರಿ ಸಂಪರ್ಕ",
        "callback":        "⏱️ ಕಾಲ್‌ಬ್ಯಾಕ್ ಸಮಯ",
        "callback_time":   "30–60 ನಿಮಿಷಗಳಲ್ಲಿ",
        "helpline_title":  "🚨 ಕಿಸಾನ್ ಕಾಲ್ ಸೆಂಟರ್ (ಉಚಿತ ಸಂಖ್ಯೆ)",
        "helpline_number": "📞 1800-180-1551 (ಬೆಳಿಗ್ಗೆ 6:00 - ರಾತ್ರಿ 10:00)",
        "existing_ticket": "ℹ️ ನೀವು ಈಗಾಗಲೇ ಸಕ್ರಿಯ ಟಿಕೆಟ್ (#{ticket_id}) ಹೊಂದಿದ್ದೀರಿ.",
        "no_local_expert": "ℹ️ ಸದ್ಯಕ್ಕೆ ಸ್ಥಳೀಯ ಅಧಿಕಾರಿ ಲಭ್ಯವಿಲ್ಲ. ನಿಮ್ಮ ಟಿಕೆಟ್ ದಾಖಲಾಗಿದೆ.",
        "hazard_warning":  "⚠️ **ಸುರಕ್ಷತಾ ಎಚ್ಚರಿಕೆ**: ತಕ್ಷಣ ಅಧಿಕಾರಿಗಳನ್ನು ಸಂಪರ್ಕಿಸಿ.",
        "inspection_note": "🌾 **ಕ್ಷೇತ್ರ ಪರಿಶೀಲನೆ ವಿನಂತಿ ದಾಖಲಾಗಿದೆ**.",
    },
    "ml": {
        "header":          "👨‍🌾 കൃഷി ഓഫീസർ ടിക്കറ്റ്: #{ticket_id}",
        "status":          "✅ നില",
        "status_assigned": "കൃഷി ഓഫീസർക്ക് നൽകിയിരിക്കുന്നു",
        "status_pending":  "തീരുമാനത്തിനായി കാത്തിരിക്കുന്നു",
        "specialist":      "👤 വിദഗ്ദ്ധൻ",
        "region":          "📍 പ്രദേശം",
        "contact":         "📞 ഫോൺ നമ്പർ",
        "callback":        "⏱️ തിരികെ വിളിക്കുന്ന സമയം",
        "callback_time":   "30–60 മിനിറ്റിനുള്ളിൽ",
        "helpline_title":  "🚨 കിസാൻ കോൾ സെന്റർ (ടോൾ ഫ്രീ)",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ സജീവമായ ടിക്കറ്റ് (#{ticket_id}) നിലവിലുണ്ട്.",
        "no_local_expert": "ℹ️ നിങ്ങളുടെ ടിക്കറ്റ് രേഖപ്പെടുത്തിയിട്ടുണ്ട്.",
        "hazard_warning":  "⚠️ **സുരക്ഷാ മുന്നറിയിപ്പ്**",
        "inspection_note": "🌾 **ഫീൽഡ് പരിശോധന രേഖപ്പെടുത്തി**.",
    },
    "mr": {
        "header":          "👨‍🌾 कृषी अधिकारी संपर्क तिकीट: #{ticket_id}",
        "status":          "✅ स्थिती",
        "status_assigned": "जिल्हा कृषी अधिकाऱ्यांना नियुक्त केले",
        "status_pending":  "अधिकारी नियुक्तीसाठी प्रलंबित",
        "specialist":      "👤 तज्ज्ञ",
        "region":          "📍 भाग",
        "contact":         "📞 अधिकारी संपर्क",
        "callback":        "⏱️ कॉलबॅक वेळ",
        "callback_time":   "30–60 मिनिटांत",
        "helpline_title":  "🚨 राष्ट्रीय किसान कॉल सेंटर (टोल-फ्री)",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ आपले तिकीट (#{ticket_id}) आधीच सक्रिय आहे.",
        "no_local_expert": "ℹ️ आपले तिकीट नोंदवले गेले आहे.",
        "hazard_warning":  "⚠️ **सुरक्षा इशारा**",
        "inspection_note": "🌾 **शेत पाहणी नोंद झाली**.",
    },
    "bn": {
        "header":          "👨‍🌾 কৃষি কর্মকর্তা যোগাযোগ টিকিট: #{ticket_id}",
        "status":          "✅ স্থিতি",
        "status_assigned": "কৃষি কর্মকর্তাকে বরাদ্দ করা হয়েছে",
        "status_pending":  "অপেক্ষমাণ",
        "specialist":      "👤 বিশেষজ্ঞ",
        "region":          "📍 অঞ্চল",
        "contact":         "📞 যোগাযোগ",
        "callback":        "⏱️ কলব্যাক সময়",
        "callback_time":   "৩০–৬০ মিনিটের মধ্যে",
        "helpline_title":  "🚨 কিষাণ কল সেন্টার (টোল-ফ্রি)",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ একটি সক্রিয় টিকিট (#{ticket_id}) রয়েছে।",
        "no_local_expert": "ℹ️ টিকিট নথিভুক্ত হয়েছে।",
        "hazard_warning":  "⚠️ **নিরাপত্তা সতর্কতা**",
        "inspection_note": "🌾 **মাঠ পরিদর্শনের অনুরোধ নথিভুক্ত**.",
    },
    "gu": {
        "header":          "👨‍🌾 કૃષિ અધિકારી સંપર્ક ટિકિટ: #{ticket_id}",
        "status":          "✅ સ્થિતિ",
        "status_assigned": "કૃષિ અધિકારીને સોંપાયેલ",
        "status_pending":  "પ્રતીક્ષારત",
        "specialist":      "👤 નિષ્ણાત",
        "region":          "📍 વિસ્તાર",
        "contact":         "📞 સંપર્ક",
        "callback":        "⏱️ કૉલબૅક સમય",
        "callback_time":   "30–60 મિનિટમાં",
        "helpline_title":  "🚨 કિસાન કૉલ સેન્ટર",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ સક્રિય ટિકિટ (#{ticket_id}) છે.",
        "no_local_expert": "ℹ️ ટિકિટ નોંધાઈ ગઈ છે.",
        "hazard_warning":  "⚠️ **સુરક્ષા ચેતવણી**",
        "inspection_note": "🌾 **ખેતર તપાસણી વિનંતી નોંધાઈ**.",
    },
    "or": {
        "header":          "👨‍🌾 କୃଷି ଅଧିକାରୀ ଟିକେଟ୍: #{ticket_id}",
        "status":          "✅ ସ୍ଥିତି",
        "status_assigned": "କୃଷି ଅଧିକାରୀଙ୍କୁ ଦିଆଯାଇଛି",
        "status_pending":  "ଅପେକ୍ଷାରତ",
        "specialist":      "👤 ବିଶେଷଜ୍ଞ",
        "region":          "📍 ଅଞ୍ଚଳ",
        "contact":         "📞 ଯୋଗାଯୋଗ",
        "callback":        "⏱️ କଲବ୍ୟାକ୍ ସମୟ",
        "callback_time":   "୩୦–୬୦ ମିନିଟ୍ ମଧ୍ୟରେ",
        "helpline_title":  "🚨 କିଷାନ କଲ୍ ସେଣ୍ଟର",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ ସକ୍ରିୟ ଟିକେଟ୍ (#{ticket_id}) ରହିଛି।",
        "no_local_expert": "ℹ️ ଟିକେଟ୍ ପଞ୍ଜୀକୃତ ହୋଇଛି।",
        "hazard_warning":  "⚠️ **ସୁରକ୍ଷା ସତର୍କତା**",
        "inspection_note": "🌾 **ଜମି ନିରୀକ୍ଷଣ ଅନୁରୋଧ ଦାଖଲ ହୋଇଛି**.",
    },
    "pa": {
        "header":          "👨‍🌾 ਖੇਤੀਬਾੜੀ ਅਧਿਕਾਰੀ ਟਿਕਟ: #{ticket_id}",
        "status":          "✅ ਸਥਿਤੀ",
        "status_assigned": "ਖੇਤੀਬਾੜੀ ਅਧਿਕਾਰੀ ਨੂੰ ਸੌਂਪੀ ਗਈ",
        "status_pending":  "ਉਡੀਕ ਵਿੱਚ",
        "specialist":      "👤 ਮਾਹਰ",
        "region":          "📍 ਖੇਤਰ",
        "contact":         "📞 ਸੰਪਰਕ",
        "callback":        "⏱️ ਕਾਲਬੈਕ ਸਮਾਂ",
        "callback_time":   "30–60 ਮਿੰਟਾਂ ਵਿੱਚ",
        "helpline_title":  "🚨 ਕਿਸਾਨ ਕਾਲ ਸੈਂਟਰ",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ ਕਿਰਿਆਸ਼ੀਲ ਟਿਕਟ (#{ticket_id}) ਹੈ।",
        "no_local_expert": "ℹ️ ਟਿਕਟ ਦਰਜ ਹੋ ਗਈ ਹੈ।",
        "hazard_warning":  "⚠️ **ਸੁਰੱਖਿਆ ਚੇਤਾਵਨੀ**",
        "inspection_note": "🌾 **ਖੇਤ ਨਿਰੀਖਣ ਬੇਨਤੀ ਦਰਜ**.",
    },
    "as": {
        "header":          "👨‍🌾 কৃষি বিষয়া যোগাযোগ টিকট: #{ticket_id}",
        "status":          "✅ স্থিতি",
        "status_assigned": "কৃষি বিষয়াক আৱণ্টন কৰা হৈছে",
        "status_pending":  "অপেক্ষাত",
        "specialist":      "👤 বিশেষজ্ঞ",
        "region":          "📍 অঞ্চল",
        "contact":         "📞 যোগাযোগ",
        "callback":        "⏱️ কলবেকৰ সময়",
        "callback_time":   "৩০–৬০ মিনিটৰ ভিতৰত",
        "helpline_title":  "🚨 কিষাণ কল চেন্টাৰ",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ সক্ৰিয় টিকট (#{ticket_id}) আছে।",
        "no_local_expert": "ℹ️ টিকট পঞ্জীয়ন হৈছে।",
        "hazard_warning":  "⚠️ **সুৰক্ষা সতৰ্কবাণী**",
        "inspection_note": "🌾 **পথাৰ পৰিদৰ্শনৰ অনুৰোধ পঞ্জীয়ন হ'ল**.",
    },
    "ur": {
        "header":          "👨‍🌾 زرعی افسر رابطہ ٹکٹ: #{ticket_id}",
        "status":          "✅ حیثیت",
        "status_assigned": "ضلعی زرعی افسر کو تفویض کردہ",
        "status_pending":  "افسر کے انتظار میں",
        "specialist":      "👤 ماہر",
        "region":          "📍 علاقہ",
        "contact":         "📞 رابطہ",
        "callback":        "⏱️ کال بیک وقت",
        "callback_time":   "30–60 منٹ کے اندر",
        "helpline_title":  "🚨 قومی کسان کال سینٹر",
        "helpline_number": "📞 1800-180-1551",
        "existing_ticket": "ℹ️ آپ کا ایک فعال ٹکٹ (#{ticket_id}) موجود ہے۔",
        "no_local_expert": "ℹ️ ٹکٹ درج کر لیا گیا ہے۔",
        "hazard_warning":  "⚠️ **حفاظتی انتباہ**",
        "inspection_note": "🌾 **کھیت کے معائنے کی درخواست درج**.",
    },
}
